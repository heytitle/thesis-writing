...
\lstinputlisting[label={annex:model_acc}, caption={Accuracies on MNIST-MAJ and Fashion-MAJ models for the quantitive evaluations (Figure \ref{fig:rel_dist_maj_3_samples_thesis}, \ref{fig:rel_dist_rlstm_exp}, and \ref{fig:rel_dist_convdeep_trans_exp}).  }]{hypothesis-testing-results/model_acc.txt}
