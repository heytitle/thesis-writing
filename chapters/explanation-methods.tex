...
\caption[xx]{A classifier classifies ``husky" as ``wolf" because of the snow background.\footnotemark }
\label{fig:husky_explanation}
\end{figure}
\footnotetext{Source : \cite{RibeiroWhyShouldTrust2016} }
}
...
\afterpage{
 \begin{figure}[!hbt]
	\begin{center}
		...
		\caption[The LOF caption]{An illustration of relevance propagation in LRP.\footnotemark}
		\label{fig:lrp_graph}
	\end{center}
\end{figure}
\footnotetext{The figure is a modified version from \url{http://heatmapping.org}}
}
